  ...
  $.widget("ui.sortable", $.ui.sortable, {
    ...
    _rearrange: function (e, item) {
      var $item,
          ...
          reset_props = {},
          offset,
          animation_direction = $.trim(this.options.animation_direction);
      ...
      offset = (this.direction == 'up' ? '' : '-') + ($item[animation_direction == 'x' ? 'width' : 'height']()) + 'px';
      ...
      if (use_css_animation) {
        props[supports['transform']] = (animation_direction == 'x' ? 'translateX' : 'translateY') + '(' + offset + ')';
      } else {
        props = {
          position: 'relative',
        };
        props[animation_direction == 'x' ? 'left' : 'top'] = offset;
      }
